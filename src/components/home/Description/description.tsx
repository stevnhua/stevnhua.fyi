...
export default function Description() {
  ...
  // OK inside a JS string; this won’t trigger the JSX unescaped-entities rule
  const phrase2 =
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          {/* escape the apostrophe in JSX text */}
          Currently a Data Scientist @Scene+, one of Canada&apos;s largest loyalty
          programs.
        </motion.p>
